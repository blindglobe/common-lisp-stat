...
;;; Sheeple is another prototype-based system.
(asdf:oos 'asdf:load-op 'sheeple)

(defpackage :regression-sheeple
  (:use common-lisp
	sheeple
	lisp-matrix
...
(defsheep =regression-model-proto= ()
...
;;   (:documentation "port of proto to SHEEPLE for Normal Linear Regression Model.")
